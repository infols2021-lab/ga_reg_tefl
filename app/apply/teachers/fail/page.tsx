...
export default function TeachersFailPage() {
  return (
    <div className="min-h-screen bg-gray-50 px-4 py-10">
      <div className="mx-auto max-w-2xl rounded-2xl bg-white p-8 shadow">
        ...
        <p className="mt-2 text-gray-600">
          Вы можете вернуться к заявке и попробовать оплатить снова. Если деньги уже списались, но статус не обновился, свяжитесь с нами и укажите данные заявки.
        </p>
