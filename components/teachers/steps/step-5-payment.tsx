          ...
          <div className="space-y-6">
              ...
              <div className="mt-4 space-y-4 text-sm leading-7 text-slate-800">
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-4">
                  ...
                  <p className="mt-2 text-slate-700">
                    В банковском приложении укажите это ФИО в поле плательщика.
                  </p>
                </div>
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-4">
                  ...
                  <span className="mt-1 block break-words text-slate-950">
                    Экзамены GA TEFL за {fullName || 'кандидата'}
                  </span>
                  <p className="mt-2 text-slate-700">
                    Скопируйте это назначение в поле «Назначение платежа».
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-3xl border border-amber-200 bg-amber-50/80 p-5">
              ...
              <div className="mt-3 space-y-2 text-sm leading-6 text-amber-900">
                ...
                <p>4. Введите ФИО плательщика вручную.</p>
                <p>5. В поле назначения платежа укажите: «Экзамены GA TEFL за ...»</p>
              </div>
            </div>
