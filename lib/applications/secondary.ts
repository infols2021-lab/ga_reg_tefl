...
export async function createSecondaryApplication(data: any) {
...
export async function updateSecondaryStep(
...
export async function submitSecondaryApplication(applicationId: string) {
  const supabase = createServerSupabaseClient();
